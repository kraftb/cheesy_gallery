...
/**
 * Domain model for images from a static collection
 *
 * @api
 */
class ImageFromStaticCollection extends ImageBase {
	...
	public function getFile() {
		...
		return static::$resourceFactory->getFileReferenceObject($this->uid);
	}
